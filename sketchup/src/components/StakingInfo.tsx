    ...
    <div className="bg-white rounded-xl shadow p-6">
      ...
      <div className="space-y-4">
        <div className="flex items-start">
          ...
          <div>
            <h3 className="font-medium text-gray-900">Fixed-Term Deposits</h3>
        ...
        <div className="flex items-start">
          ...
          <div>
            <h3 className="font-medium text-gray-900">Predictable Rewards</h3>
            <p className="text-gray-600 text-sm mt-1">
        ...
        <div className="border-t pt-4">
          <h3 className="font-medium text-gray-900 mb-2">Current Terms</h3>
