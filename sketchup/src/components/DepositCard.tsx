    ...
    <div className="bg-white rounded-xl shadow overflow-hidden">
      <div className="p-4">
        <div className="flex justify-between items-start">
          <div>
            <h3 className="font-bold text-lg text-gray-900">{deposit.amount} GGW</h3>
        ...
        <div className="mt-4 flex space-x-2">
          <button
            ...
            disabled={isLocked}
            className="flex-1 py-1.5 text-sm bg-gray-100 hover:bg-gray-200 rounded disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Withdraw
          </button>
          <button className="flex-1 py-1.5 text-sm bg-white border border-gray-300 hover:bg-gray-50 rounded">
            Details
          </button>
        </div>
      </div>
